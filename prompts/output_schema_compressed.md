...
**assessment** (required): A concise paragraph summarizing the overall clinical picture so far. This field will be used as context for the next step, so include key findings, working diagnosis, and important negatives.
